...
- We have created `r NROW(unique(result_reclin$result$block))` blocks.
- The blocking process utilized `r NROW(result_reclin$colnames)` columns (2 character shingles).
