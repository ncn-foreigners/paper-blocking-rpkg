...
the documentation of the `pair_ann()` function and the vignette entitled [`"Integration with existing packages"`](https://cran.r-project.org/web/packages/blocking/vignettes/v3-integration.html)
...
We also have developed a python version of the package [{BlockingPy}](https://blockingpy.readthedocs.io/en/latest/) that
