...
company, job position) in absence of unique identifiers. This situation is frequently observed in
...
\CRANpkg{reclin2} package, as described in one of the package vignettes. However, the \CRANpkg{blocking} package is not limited to the \CRANpkg{reclin2} and can be applied in various record linkage or deduplication contexts.
