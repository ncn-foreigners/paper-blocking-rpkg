...
#> Number of shingles created for blocking: 1232.
...
package, where a simple score is calculated as the sum of Jaro-Winkler similarity measures
(cf. \citet{Winkler1990}) for the variables \texttt{fname}, \texttt{surname}, and \texttt{date}.
...
\caption{\label{tab:comparision}Comparison of various approximate nearest neighbour algorithms implemented in the \CRANpkg{blocking} and the \CRANpkg{klsh} package for creation of blocks for deduplication (values in percentages)}
\centering
